...
func ActionPayload(collectionName string, id string, action string, updateData map[string]interface{}) *custom_error.CustomError {

	errSchema := ValidatePayloadBySchema(collectionName, action, updateData)
